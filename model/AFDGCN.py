...
class AVWGCN(nn.Module):
    ...
    def forward(self, x, node_embedding):
        ...
        coeffs = generateCoeff(11, 'Chebyshev', 'g_1', False, False, -0.9, 0.9, True)
        #coeffs = generateCoeff(11, 'Chebyshev', 'g_2', False, False, -0.9, 0.9, True)
        #coeffs = generateCoeff(11, 'Chebyshev', 'g_3', False, False, -0.9, 0.9, True)
